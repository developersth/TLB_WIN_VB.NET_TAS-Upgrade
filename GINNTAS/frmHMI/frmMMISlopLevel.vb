...
Public Class frmMMISlopLevel

    
        Dim P_ComputerName As String = System.Net.Dns.GetHostName
        Private iconfig_name As String
        Private Sub cmdSet_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdSet.Click
            ...
            With MSGridConfig
                For i = 0 To MSGridConfig.RowCount - 1
                    ...
                    Call SaveData("LEVEL_SLOP_BASE_OIL", CLng(Trim(MSGridConfig.Rows(i).Cells(0).Value.ToString)), Trim(MSGridConfig.Rows(i).Cells(3).Value.ToString))
                    End If
                Next
            End With
        ...
        strSQL = "select t.* " & _
                   " from steqi.view_config_level_slop_setting t" & _
                   " Where t.CONFIG_NAME='LEVEL_SLOP_BASE_OIL' " & _
