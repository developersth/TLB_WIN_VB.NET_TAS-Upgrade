...
Public Class frmConfigPrinters_main
    Public FormScreenID As Long
    Dim frm_work As Integer = 0 '1=add ,2=Edit

    Private Sub frmConfigPrinters_main_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
        'UcStatus1.StopThread()
        UcFooter1.StopThread()
        CloseForm(FormScreenID, "")
    End Sub

    Private Sub frmConfigPrinters_main_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        SetScreenResulotion()
        CheckFormResize(Me)
    ...
    Private Sub frmConfigPrinters_main_Resize(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Resize
        CheckFormResize(Me)
    End Sub
    ...
    Public Sub Show_Data()
        ...
        sql_str = _
        "select P.PRINTER_ID,P.PRINTER_NAME,P.IS_ENABLED,P.UPDATE_DATE,P.UPDATED_BY " & _
        ...
        If Oradb.OpenDys(sql_str, "TableName1", mDataSet) Then
            ...
            Do While dt.Rows.Count > i
                ...
                DataGridView1.Item(0, i).Value = IIf(IsDBNull(dt.Rows(i).Item("PRINTER_ID")), "", dt.Rows(i).Item("PRINTER_ID").ToString)
                DataGridView1.Item(1, i).Value = IIf(IsDBNull(dt.Rows(i).Item("PRINTER_NAME")), "", dt.Rows(i).Item("PRINTER_NAME").ToString)
    ...
    Private Sub Delete()
        ...
        sql_str = sql_str & " WHERE  PRINTER_ID = '" + DataGridView1.Item(0, DataGridView1.CurrentRow.Index).Value.ToString + "' "
...
#Region "Menu Event"
    ...
    Private Sub UcMenuAdd_OnClickMnuText(ucName As System.String, ucScreenID As System.Int64) Handles UcMenuAdd.OnClickMnuText
        frmConfigPrinters_sub.Close()
        frmConfigPrinters_sub.setFrmWork(1)
        frmConfigPrinters_sub.ShowDialog()
    End Sub
    ...
    Private Sub UcMenuEdit_OnClickMnuText(ucName As System.String, ucScreenID As System.Int64) Handles UcMenuEdit.OnClickMnuText
        ...
        frmConfigPrinters_sub.Close()
        frmConfigPrinters_sub.setFrmWork(2)
        frmConfigPrinters_sub.setPkId(id)
        frmConfigPrinters_sub.ShowDialog()
    End Sub
    ...
    Private Sub UcMenuDelete_OnClickMnuText(ucName As System.String, ucScreenID As System.Int64) Handles UcMenuDelete.OnClickMnuText
        Dim result As Integer = MessageBox.Show("ต้องการลบข้อมูลของเครื่องพิมพ์ : " + DataGridView1.Item(0, DataGridView1.CurrentRow.Index).Value.ToString + " หรือไม่ ?", "System TAS", MessageBoxButtons.YesNo)
...
#End Region
    ...
    Private Sub UcHeader1_MinimizeButtonClick(sender As Object, e As EventArgs) Handles UcHeader1.MinimizeButtonClick
        Me.WindowState = FormWindowState.Minimized
    End Sub
    Private Sub UcBack1_Click(sender As Object, e As EventArgs) Handles UcBack1.Click, Panel4.Click
        Try
            Me.Close()
        Catch ex As Exception
    ...
    Private Sub UcBack1_MouseHover(sender As Object, e As EventArgs) Handles UcBack1.MouseHover, Panel4.MouseHover
        UcBack1.BackgroundImage = My.Resources.ResourceManager.GetObject("Back1")
    End Sub

    Private Sub UcBack1_MouseLeave(sender As Object, e As EventArgs) Handles UcBack1.MouseLeave, Panel4.MouseLeave
