...
Public Class frmLoadingSystem
    Public FormScreenID As Long

    Private Sub frmLoadingSystem_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        SetScreenResulotion()
        CheckFormResize(Me)
        'InitialFormMnuType1(Me, lblTitleName.Text)
        UcStatus1.StartThread()
    End Sub

    Private Sub frmLoadingSystem_FormClosed(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
    ...
    Private Sub frmLoadingSystem_Resize(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Resize
        'CheckFormResize(Me)
    End Sub
