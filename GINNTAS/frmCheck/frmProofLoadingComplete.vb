...
Public Class frmProofLoadingComplete
    ...
    Private Sub frmProofLoadingComplete_FormClosed(ByVal sender As Object, ByVal e As System.Windows.Forms.FormClosedEventArgs) Handles Me.FormClosed
        'UcStatus1.StopThread()
        UcFooter1.StopThread()
        CloseForm(FormScreenID, "")
    End Sub

    Private Sub frmProofLoadingComplete_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub frmProofLoadingComplete_Resize(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Resize
        CheckFormResize(Me)
    End Sub
    ...
    Public Sub Showdata_GridMain()
        ...
        sql_str = _
                  "SELECT H.LOAD_HEADER_NO,H.SHIPMENT_NO,S.STATUS_NUMBER||' - '||S.DESCRIPTION as STATUS,H.TRIP_NO,H.TU_CARD_NO,H.VEHICLE_ID,H.TU_ID," & _
            "H.DRIVER_NAME,H.SEAL_NUMBER,H.T_BILLING,H.LOCKED,S.STATUS_NUMBER," & _
            "H.T_START,H.T_STOP,H.IS_EOD,H.EOD_DATE,H.CANCEL_STATUS  " & _
            "FROM TAS.OIL_LOAD_HEADERS H,STATUS_DESC S " & _
            ...
            "AND S.T_NAME='OIL_LOAD_HEADERS' " & _
            "AND S.COLUMNS_NAME='LOAD_STATUS' " & _
            "ORDER BY H.LOAD_HEADER_NO DESC"
    ...
    Private Sub cmdBay_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Call selectButton(1)
    End Sub
    Private Sub selectButton(ByVal Status As Long)
        Dim sql_str As String
        Dim mDataSet As New DataSet
        Dim dt As DataTable
        Dim i, j, k As Integer
        ...
        Select Case Status
            Case 1
                Statement = " S.STATUS_NUMBER in('51','52','53') "
            Case 2
                Statement = " S.STATUS_NUMBER in('81') "
            Case 3
                Statement = " S.STATUS_NUMBER in('55') "
            Case Else
        End Select
        sql_str = _
                  "SELECT H.LOAD_HEADER_NO,H.SHIPMENT_NO,S.STATUS_NUMBER||' - '||S.DESCRIPTION as STATUS,H.TRIP_NO,H.TU_CARD_NO,H.VEHICLE_ID,H.TU_ID," & _
    ...
    Private Sub cmdLcomplete_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
        Call selectButton(3)
    End Sub
    ...
    Private Sub b_PrintReport_Click(sender As System.Object, e As System.EventArgs)
    ...
    Private Sub UcMenuPrintReport_OnClickMnuText(ucName As System.String, ucScreenID As System.Int64) Handles UcMenuPrintReport.OnClickMnuText
        Dim index As Integer = DataGridView_Headers.CurrentRow.Index
        frmrptShowReport.mParameter = DataGridView_Headers.Rows(index).Cells(0).Value
