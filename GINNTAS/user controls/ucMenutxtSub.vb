...
#End Region
    ...
    'Private Sub ucMnuTextSub_Disposed(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Disposed
    '    'DispostObj()
    'End Sub

    Private Sub ucMnuTextSub_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'SetMenuTextAlign()
    End Sub

    Private Sub ucMnuTextSub_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Resize
        InitializeObj()
        'SetMenuTextAlign()
    End Sub
