Public Class ucDelete
    ...
    Event OnClickDelete(ByVal ucName As String, ByRef ucScreeenID As Long)
#Region "uc Property"
...
#Region "uc Event"
    Private Sub ucClick()
        If P_CHECK_SCREEN_AUTHORIZE(mUserName, Me._MenuScreenID, Me._MenuAuthorizeID) Then
            RaiseEvent OnClickDelete(Me.Name, Me._MenuScreenID)
        End If
    End Sub
#End Region
    Public Sub New()
    ...
    Private Sub ucDelete_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize

    End Sub

    Private Sub ucDelete_MouseClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles MyBase.MouseClick
        ucClick()
    End Sub
