Public Class ucSearch
    ...
    Event OnClickSearch(ByVal ucName As String)

#Region "uc Event"
    Private Sub ucClick()
        RaiseEvent OnClickSearch(Me.Name)
    End Sub
#End Region
    ...
    Private Sub ucSearch_Resize(ByVal sender As Object, ByVal e As System.EventArgs)
