Public Class ucNetworkStatus
    Dim arrayListStatusMachine As New Collection
    Public xPicBG = 100
    Public yPicBG = 111
    Public Sub init()
        arrayListStatusMachine.Add(statusMachine1)
        arrayListStatusMachine.Add(statusMachine2)
        arrayListStatusMachine.Add(statusMachine3)
        arrayListStatusMachine.Add(statusMachine4)
        arrayListStatusMachine.Add(statusMachine5)
        arrayListStatusMachine.Add(statusMachine6)
        arrayListStatusMachine.Add(statusMachine7)
        arrayListStatusMachine.Add(statusMachine8)
        arrayListStatusMachine.Add(statusMachine9)
        arrayListStatusMachine.Add(statusMachine10)

        arrayListStatusMachine.Add(statusMachine11)
        arrayListStatusMachine.Add(statusMachine12)
        arrayListStatusMachine.Add(statusMachine13)
        arrayListStatusMachine.Add(statusMachine14)
        arrayListStatusMachine.Add(statusMachine15)
        arrayListStatusMachine.Add(statusMachine16)
        arrayListStatusMachine.Add(statusMachine17)
        arrayListStatusMachine.Add(statusMachine18)
        arrayListStatusMachine.Add(statusMachine19)
        arrayListStatusMachine.Add(statusMachine20)

        arrayListStatusMachine.Add(statusMachine21)
        arrayListStatusMachine.Add(statusMachine22)
        arrayListStatusMachine.Add(statusMachine23)
        arrayListStatusMachine.Add(statusMachine24)
        arrayListStatusMachine.Add(statusMachine25)
        arrayListStatusMachine.Add(statusMachine26)
        arrayListStatusMachine.Add(statusMachine27)
        arrayListStatusMachine.Add(statusMachine28)
        arrayListStatusMachine.Add(statusMachine29)
        arrayListStatusMachine.Add(statusMachine30)

        arrayListStatusMachine.Add(statusMachine31)
        arrayListStatusMachine.Add(statusMachine32)
        arrayListStatusMachine.Add(statusMachine33)
        arrayListStatusMachine.Add(statusMachine34)
        arrayListStatusMachine.Add(statusMachine35)
        arrayListStatusMachine.Add(statusMachine36)
        arrayListStatusMachine.Add(statusMachine37)


        'arrayListStatusMachine.Add("NY", "New York")
    End Sub
    Public Sub Show_Data()
        ...
        'pic.Parent = picBG
        'pic.Location = New Point(pic.Location.X - xPicBG, pic.Location.Y - yPicBG)
        ...
        '100, 111
        picBG.Image = My.Resources.ResourceManager.GetObject("SystemNetwork100Per_transparent")
        'statusMachine18.Image = My.Resources.ResourceManager.GetObject("GG")
        'statusMachine19.Image = My.Resources.ResourceManager.GetObject("GG")
