...
Public Class UcFlowLoading
    ...
    Public Sub GetDetailFlowLineMeter(ByVal Index As Integer)
        ...
        strSQL =
                  ...
                  " ,t.PRESSURE_DIFF_ALARM,t.TEMP_1_ALARM,t.TEMP_NAME1,t.TEMPERATURE1,t.FV_CONTROL ,t.FLOW_ACTIVE,t.ARM_DOWN_A,t.ARM_DOWN_B,t.EARTH_A,t.EARTH_B,t.EARTH_C,t.OVERSFILL_A,t.OVERSFILL_B,t.ESD ,t.PREMISSIVE_A,t.PREMISSIVE_B,t.PREMISSIVE_C  " &
                  " ,t.BALL_VALVE_A,t.BALL_VALVE_B,t.BALL_VALVE_C " &
        ...
        If Oradb.OpenDys(strSQL, "TableName1", mDataSet) Then
            ...
            If dt.Rows.Count > 0 Then
                ...
                If ((CInt(dt.Rows(i).Item("ARM_SIDE_A")) = 1) And (CInt(dt.Rows(i).Item("BALL_VALVE_A")) = 1)) Then
                    ConTrolAniGifBallVale(2)
                ElseIf ((CInt(dt.Rows(i).Item("ARM_SIDE_B")) = 1) And (CInt(dt.Rows(i).Item("BALL_VALVE_B")) = 1)) Then
                    ConTrolAniGifBallVale(2)
                ElseIf (CInt(dt.Rows(i).Item("BALL_VALVE_C")) = 1) Then
                    ConTrolAniGifBallVale(2)
                Else
                ...
                Call SaftGarudingAc(IIf(IsDBNull(dt.Rows(i).Item("BALL_VALVE_C")), 0, dt.Rows(i).Item("BALL_VALVE_C")), txt(34))
                Call SaftGarudingAc(IIf(IsDBNull(dt.Rows(i).Item("EARTH_C")), 0, dt.Rows(i).Item("EARTH_C")), txt(33))
                Call SaftGarudingAc(IIf(IsDBNull(dt.Rows(i).Item("PREMISSIVE_C")), 0, dt.Rows(i).Item("PREMISSIVE_C")), txt(32))
                ...
                If vScan_Time Then
                    ...
                    'disabled not meter 12 side c
                    If IIf(IsDBNull(dt.Rows(i).Item("METER_NO")), 0, dt.Rows(i).Item("METER_NO")) <> 12 Then
                        lblSideC.Visible = False
    ...
    Private Sub GetMeterCount()
        ...
        If Oradb.OpenDys(strSQL, "TableName1", mDataSet) Then
            ...
            dt = mDataSet.Tables("TableName1")
            If dt.Rows.Count > 0 Then
                ReDim Preserve vMeter(IIf(IsDBNull(dt.Rows(i).Item("coutMeter")), 0, dt.Rows(i).Item("coutMeter")))
            End If
        Else
        End If
        mDataSet = Nothing
